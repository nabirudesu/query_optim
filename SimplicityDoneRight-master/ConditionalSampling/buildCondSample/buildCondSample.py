...
if __name__ == "__main__":
	...
	forest_file_path = current_dir + "/forest.csv"
	df_table = pandas.read_csv(forest_file_path,  header = None, names = names)
	df_table = df_table.apply(lambda col: pandas.to_numeric(col, errors='coerce'))
	...
	parser.add_argument('--output',help="path to output of buildCondSample.py", type=str, default="buildCondSample/cond_sample_5q.pkl")
